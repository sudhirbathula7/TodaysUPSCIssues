...
BODY_BOLD_FONT_NAME = "Helvetica-Bold"

BODY_FONT_SIZE = 8.0
BODY_LEADING = 9.0

MIN_BODY_FONT_SIZE = 6.4
MIN_BODY_LEADING = 7.6

QUESTION_FONT_NAME = BODY_FONT_NAME
QUESTION_BOLD_FONT_NAME = BODY_BOLD_FONT_NAME
QUESTION_FONT_SIZE = BODY_FONT_SIZE
QUESTION_LEADING = BODY_LEADING
MIN_QUESTION_FONT_SIZE = MIN_BODY_FONT_SIZE
MIN_QUESTION_LEADING = MIN_BODY_LEADING

ANCHOR_FONT_NAME = BODY_FONT_NAME
ANCHOR_FONT_SIZE = BODY_FONT_SIZE
ANCHOR_LEADING = BODY_LEADING
MIN_ANCHOR_FONT_SIZE = MIN_BODY_FONT_SIZE
MIN_ANCHOR_LEADING = MIN_BODY_LEADING
